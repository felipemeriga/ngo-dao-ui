...
export interface NGODAOInterface extends utils.Interface {
  functions: {
    ...
    "createProposal(string,address,uint256,bytes)": FunctionFragment;
  ...
  events: {
    ...
    "ProposalCreated(uint256,string,address,uint256,uint256)": EventFragment;
...
export interface NGODAO extends BaseContract {
  ...
  filters: {
    ...
    "ProposalCreated(uint256,string,address,uint256,uint256)"(
